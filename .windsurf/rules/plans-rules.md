...
## Directory Setup
**Plans folder creation**
- If the `/plans/` directory does not exist in the project, the assistant must create it before creating any plan files.
- The `/plans/` directory should be created at the root of the project.
...
**Create rules**
- Ensure `/plans/` directory exists before creating the file
- Set **Status: draft**
