        ...
        <div className="flex flex-col gap-2 px-2 flex-grow">
          ...
          <div className="flex items-center justify-between mt-auto pt-2">
            <div className="flex flex-col">
              <span className="text-lg font-bold text-[#002684]">
                ${(product.price / 100).toFixed(2)}
              </span>
              {product.compareAtPrice && product.compareAtPrice > product.price && (
                <span className="text-xs text-[#002684]/40 line-through">
            ...
            <Button 
              size="sm"
              variant="outline"
              className="rounded-full border-[#1d4ed8] text-[#1d4ed8] hover:bg-[#1d4ed8] hover:text-white font-semibold transition-all h-9 px-4"
            >
              View
            </Button>
          </div>
